...
export function MobileCtaBar() {
  return (
    <div
      ...
      className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-2 gap-2 border-t border-pine-deep/30 bg-cream/95 p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] backdrop-blur sm:hidden"
    >
      <a
